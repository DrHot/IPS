...
main:
	...
	addi	$29, $29, -28
	ori	$10, $0, 7
# was:	ori	_n_reg_10_, 0, 7
	ori	$14, $0, 0
# was:	ori	_a_reg_11_, 0, 0
	ori	$17, $28, 0
# was:	ori	_letBind_6_, 28, 0
	addi	$11, $10, 3
# was:	addi	_tmp_12_, _n_reg_10_, 3
	sra	$11, $11, 2
# was:	sra	_tmp_12_, _tmp_12_, 2
	sll	$11, $11, 2
# was:	sll	_tmp_12_, _tmp_12_, 2
	addi	$11, $11, 4
# was:	addi	_tmp_12_, _tmp_12_, 4
	add	$28, $28, $11
# was:	add	28, 28, _tmp_12_
	sw	$10, 0($17)
# was:	sw	_n_reg_10_, 0(_letBind_6_)
	addi	$13, $17, 4
# was:	addi	_x_reg_8_, _letBind_6_, 4
	ori	$11, $0, 0
# was:	ori	_i_reg_9_, 0, 0
_loop_beg_13_:
	sub	$12, $11, $10
# was:	sub	_t_reg_7_, _i_reg_9_, _n_reg_10_
	bgez	$12, _loop_end_14_
# was:	bgez	_t_reg_7_, _loop_end_14_
	addi	$11, $11, 1
# was:	addi	_i_reg_9_, _i_reg_9_, 1
	sb	$14, 0($13)
# was:	sb	_a_reg_11_, 0(_x_reg_8_)
	addi	$13, $13, 1
# was:	addi	_x_reg_8_, _x_reg_8_, 1
	j	_loop_beg_13_
_loop_end_14_:
# 	ori	_arr_reg_15_,_letBind_6_,0
	lw	$18, 0($17)
# was:	lw	_size_reg_16_, 0(_arr_reg_15_)
	ori	$16, $28, 0
# was:	ori	_mainres_5_, 28, 0
	addi	$10, $18, 3
# was:	addi	_tmp_23_, _size_reg_16_, 3
	sra	$10, $10, 2
...
# was:	sw	_size_reg_16_, 0(_mainres_5_)
	addi	$19, $16, 4
# was:	addi	_arr2_reg_17_, _mainres_5_, 4
	ori	$20, $0, 0
...
_loop_beg_20_:
	sub	$2, $20, $18
# was:	sub	_tmp_reg_19_, _i_reg_18_, _size_reg_16_
	bgez	$2, _loop_end_21_
# was:	bgez	_tmp_reg_19_, _loop_end_21_
	addi	$20, $20, 1
# was:	addi	_i_reg_18_, _i_reg_18_, 1
	lb	$2, 0($17)
# was:	lb	_tmp_reg_19_, 0(_arr_reg_15_)
	addi	$17, $17, 1
# was:	addi	_arr_reg_15_, _arr_reg_15_, 1
# 	ori	2,_tmp_reg_19_,0
	jal	writeBool
# was:	jal	writeBool, 2
# 	ori	_tmp_reg_22_,2,0
# 	ori	_tmp_reg_19_,_tmp_reg_22_,0
	sb	$2, 0($19)
# was:	sb	_tmp_reg_19_, 0(_arr2_reg_17_)
	addi	$19, $19, 1
# was:	addi	_arr2_reg_17_, _arr2_reg_17_, 1
	j	_loop_beg_20_
_loop_end_21_:
	ori	$2, $16, 0
