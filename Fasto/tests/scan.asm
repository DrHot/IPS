...
# was:	sw	_size_reg_19_, 0(_letBind_15_)
	ori	$2, $0, 0
# was:	ori	_acc_reg_17_, 0, 0
	addi	$19, $16, 4
# was:	addi	_res_reg_18_, _letBind_15_, 4
	addi	$18, $18, 4
...
# 	ori	_acc_reg_17_,_tmp_reg_25_,0
	sw	$2, 0($19)
# was:	sw	_acc_reg_17_, 0(_res_reg_18_)
	addi	$19, $19, 4
...
_loop_end_23_:
	ori	$17, $16, 0
# was:	ori	_arr_reg_26_, _letBind_15_, 0
	lw	$18, 0($17)
...
# was:	add	28, 28, _tmp_34_
	sw	$18, 0($16)
# was:	sw	_size_reg_27_, 0(_mainres_9_)
	addi	$19, $16, 4
# was:	addi	_arr2_reg_28_, _mainres_9_, 4
	ori	$20, $0, 0
