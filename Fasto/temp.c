...
static const MonoBundledAssembly assembly_bundle_CodeGen_dll = {"CodeGen.dll", assembly_data_CodeGen_dll, 34304};
...
static const MonoBundledAssembly assembly_bundle_Lexer_dll = {"Lexer.dll", assembly_data_Lexer_dll, 44032};
...
static const MonoBundledAssembly assembly_bundle_Parser_dll = {"Parser.dll", assembly_data_Parser_dll, 104448};
